...
var Tooltip = React.createClass({
  ...
  _setStyles: function(opts, styles, stepStyles) {
    ...
    if (stepStyles) {
      ...
      if (stepStyles.topOffset) {
        styles.tooltip.top = styles.tooltip.top + stepStyles.topOffset;
      }

      if (stepStyles.leftOffset) {
        styles.tooltip.left = styles.tooltip.left + stepStyles.leftOffset;
      }
      ...
      if (stepStyles.holeOffset) {
        var offset = stepStyles.holeOffset;
        styles.hole.top = offset.top ? styles.hole.top + offset.top : styles.hole.top;
        styles.hole.left = offset.left ? styles.hole.left + offset.left : styles.hole.left;
        styles.hole.width = offset.width ? styles.hole.width + offset.width : styles.hole.width;
        styles.hole.height = offset.height ? styles.hole.height + offset.height : styles.hole.height;
      } 
    }
